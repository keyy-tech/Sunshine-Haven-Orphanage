...
<body>
    ...
    <main>
        ...
        <a href="add_dailyactivities.php" class="btn btn-outline-success mb-3 mt-2">
            Add New Record</a>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $TIME; ?></td>
                        <td>
                            <a href="update_dailyactivities.php?id=<?php echo $ID; ?>" type="button" class="btn btn-outline-primary">Update</a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="delete_dailyactivities.php?id=<?php echo $ID; ?>" type="button" class="btn btn-danger">Confirm Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
